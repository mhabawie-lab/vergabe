/**
 * Datenbanktypen, erzeugt aus dem angewendeten Schema.
 *
 * NICHT von Hand bearbeiten. Neu erzeugen mit:
 *
 *   npm run supabase:types                     # gegen eine lokale Instanz
 *   npx supabase gen types typescript --project-id <ref> > src/types/database.ts
 *
 * Diese Datei beschreibt Tabellen, Sichten, Enums und Funktionen so, wie sie
 * tatsächlich in der Datenbank stehen — im Unterschied zu den Typen in
 * src/types/*.ts, die die Anwendungssicht beschreiben. Die Adapter bilden
 * zwischen beiden ab.
 */
